...
JSON만 응답하세요:
{
  ...
  "deficiencies": [
    ...
    console.log(`  🧪 성분 분석 완료: 경고 ${result.warnings?.length || 0}건, 주의 ${result.cautions?.length || 0}건, 시너지 ${result.synergies?.length || 0}건, 영양소 체크 ${result.deficiencies?.length || 0}건`);
